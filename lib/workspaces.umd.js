(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    class Workspace {
        ...
        close() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield controller.closeItem(this.id, frameToClose);
            });
        }
        snapshot() {
    ...
    class CoreController {
        ...
        createWorkspace(definition, saveConfig) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const workspace = yield this.base.createWorkspace(createConfig, frameInstance);
                yield this.frameUtils.focusFrame(frameInstance);
                return workspace;
            });
        }
        restoreWorkspace(name, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const workspace = yield this.base.restoreWorkspace(name, options, frameInstance);
                yield this.frameUtils.focusFrame(frameInstance);
                return workspace;
            });
        }
        ...
        closeItem(itemId, frame) {
            return __awaiter(this, void 0, void 0, function* () {
                const frameInstance = yield this.frameUtils.getFrameInstanceByItemId(itemId);
                const isItemFrame = itemId === frameInstance.peerId;
                yield this.base.closeItem(itemId, frameInstance);
                if (isItemFrame) {
                    return yield this.frameUtils.closeFrame(frameInstance);
                }
                if (frame) {
                    return yield frame.close();
                }
            });
        }
        resizeItem(itemId, config) {
    ...
    class CoreFrameUtils {
        constructor(interop, windows, bridge, assetsBaseLocation) {
            this.interop = interop;
            this.windows = windows;
            this.bridge = bridge;
            this.assetsBaseLocation = assetsBaseLocation;
            this.workspacesIndex = "/workspaces/";
            this.defaultAssetsBase = "/glue";
    ...
    class IoC {
        constructor(agm, windows, layouts, assetsBaseLocation) {
            this.agm = agm;
            this.windows = windows;
            this.layouts = layouts;
            this.assetsBaseLocation = assetsBaseLocation;
    ...
    const factoryFunction = (glue, config) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const ioc = new IoC(glue.agm, glue.windows, glue.layouts, (_a = config === null || config === void 0 ? void 0 : config.assets) === null || _a === void 0 ? void 0 : _a.location);
        yield ioc.initiate();
